...
public abstract class BaseActivity extends RxAppCompatActivity implements View.OnClickListener {
    ...
    protected void onTitleBackPress() {
        View backView_iv = findViewById(R.id.title_left_back);
        View backView_tv = findViewById(R.id.common_header_back_tv);
        if (backView_iv != null) {
            backView_iv.setOnClickListener(v -> ActivityManager.getInstance().removeCurrent());
        }
        if (backView_tv != null) {
            backView_tv.setOnClickListener(v -> ActivityManager.getInstance().removeCurrent());
        }
    }

...
import com.mall.dayi.ui.widget.FixedSpeedScroller;
...
public class CommonUtil {
    ...
    public static int sp2px(float spValue) {
        float fontScale = DaYiApp.getContext().getResources().getDisplayMetrics()
                .scaledDensity;
    ...
    public static float getDimen(int id) {
        return DaYiApp.getContext().getResources().getDimension(id);
    }

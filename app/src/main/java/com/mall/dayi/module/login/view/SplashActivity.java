...
import com.mall.dayi.bean.response.AppUpdateRes;
...
//                goMianActivity();
    ...
    private void normalUpdate(AppUpdateRes appUpdateRes) {
        isUpdate = true;
        alterNormalDialog = new CommonDialog(mContext, R.style.common_dialog, R.layout.dialog_update_app);
    ...
    private void focuseUpdate(AppUpdateRes appUpdateRes) {
        isUpdate = true;
        alterFocusDialog = new CommonDialog(mContext, R.style.common_dialog, R.layout.dialog_update_app);
